package cmpe277.sjsu.edu.newsapp.Adapter
...
class NewsAdapter : RecyclerView.Adapter<NewsAdapter.ArticleViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ArticleViewHolder, position: Int) {
        ...
        holder.itemView.apply {
            ...
            val tvSrc : TextView = findViewById(R.id.tvSource)
            tvSrc.text = article.source.name
            ...
            val tvPublishAt : TextView = findViewById(R.id.tvPublishedAt)
